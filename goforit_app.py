...
with tab1:
    ...
    # IMPORTANTE: Los selectores de modo se ponen FUERA del form para que el iPad refresque la pantalla
    col_modos_1, col_modos_2 = st.columns(2)
    with col_modos_1:
        modo_foco = st.radio("¿Modo Foco?", ["Existente", "Nuevo"], horizontal=True, key="m_foco")
    with col_modos_2:
        modo_nom = st.radio("¿Modo Participante?", ["Existente", "Nuevo"], horizontal=True, key="m_nom")
...
with tab2:
    if not df_empresa.empty:
        ...
        else: st.warning("Aplica filtros.")
